...
namespace ProjeX_API.Migrations
{
    ...
    [Migration("20230427181719_Categories and tasks models tuning")]
    partial class Categoriesandtasksmodelstuning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjeX_API.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjeX_API.Models.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjeX_API.Models.Task", b =>
                {
                    b.HasOne("ProjeX_API.Models.User", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("AssignedToId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjeX_API.Models.Category", null)
                        .WithMany("Tasks")
